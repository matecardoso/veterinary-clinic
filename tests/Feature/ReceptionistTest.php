...
class ReceptionistTest extends TestCase
{
	...
	public function test_receptionist_can_view_appointments_by_date_and_animal_type()
	{
		...
		$nonMatchingAppointment1 = Appointment::factory()->create([
			'appointment_date' => '2024-08-16',
			'animal_type' => 'dog',
		]);

		$nonMatchingAppointment2 = Appointment::factory()->create([
			'appointment_date' => '2024-08-15',
			'animal_type' => 'cat',
		]);
		...
		$response->assertSee($matchingAppointment->person_name);
		$response->assertDontSee($nonMatchingAppointment1->person_name);
		$response->assertDontSee($nonMatchingAppointment2->person_name);
	}
